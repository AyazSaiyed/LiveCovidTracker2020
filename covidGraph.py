...
class CountryWise:
    ...
    #Confirmed
        ...
        plt.title('Total Confirmed Cases Based on Countries ( Generated from Yudiz Covid Tracker )')
        fig = plt.gcf()
        # plt.show()
        fig.savefig('./static/ConfirmedCases.png', dpi=100)
        # plt.show()
    ...
    #dead
        ...
        plt.xticks(x,x,rotation=90)
        plt.title('Total Death Cases Based on Countries ( Generated from Yudiz Covid Tracker )')
        fig = plt.gcf()
        # plt.show()
        fig.savefig('./static/DeadCases.png', dpi=100)
        # plt.show()
    ...
    #recovered
        ...
        plt.xticks(x,x,rotation=90)
        plt.title('Total Recovered Cases Based on Countries ( Generated from Yudiz Covid Tracker )')
        fig = plt.gcf()
        # plt.show()
        fig.savefig('./static/RecoveredCases.png', dpi=100)
        # plt.show()
